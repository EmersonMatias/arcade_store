...
export default function Footer() {
    const columns = [
        ...
        { title: "Políticas", texts_paths: [{text:"Termos e Condições", path:"termosecondicoes"}, {text:"Política de Envio", path: "politicadeenvio"}, {text:"Política de Reembolso", path:"politicadereembolso"}, {text:"Política de Privacidade", path:"politicadeprivacidade"}, {text:"Política de Cookies", path: ""}, {text:"FAQ", path: ""}] }
    ]
